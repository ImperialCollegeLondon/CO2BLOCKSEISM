...
function [thick,area_res,perm,por,dens_c,visc_c,visc_w,compr,rc,...
    ...
    %---------------------------------------------------------------------
    % bottom reservoir depth [m]
    depth_bottom = depth_mean + thick/2 ;
    % pressure at mid reservoir depth [MPa]
    pres_mean = pres_offset + pres_grad*(depth_mean - depth_water) ;
    % temperature at mid reservoir depth [C]
    T_mean = temp_surf + temp_grad*(depth_mean - depth_water);
